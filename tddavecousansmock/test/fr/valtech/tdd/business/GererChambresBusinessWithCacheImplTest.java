...
public class GererChambresBusinessWithCacheImplTest {

	@Test
	public void validerUtilisationCache() {
		Date nuitee = DateHelper.createDate(2009, 5, 30);
		int capacite = 3;
		GererChambresBusinessWithCacheImpl gererChambresBusiness = new GererChambresBusinessWithCacheImpl();
		...
		dispoChambre2Personnes30Mai2009 = gererChambresBusiness
				.consulterDisponibiliteChambre(capacite, nuitee);
		Assert.assertTrue(dispoChambre2Personnes30Mai2009);
